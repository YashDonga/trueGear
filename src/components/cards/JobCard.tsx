...
export function JobCard({ title, description, details, price, isSelected, onToggle }: JobCardProps) {
  return (
    <button
      onClick={onToggle}
      className={`bg-white rounded-[10px] border border-[#e5e7eb] p-5 w-full transition-all hover:shadow-md ${
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className={`${
            ...
            } flex items-center justify-center rounded-full size-12.5 border shadow-[2px_4px_8px_0px_rgba(0,0,0,0.15)] transition-all`}>
            {isSelected ? (
        ...
        {/* Price */}
        <div className="text-[16px] font-semibold text-[#333] text-right">
          {price}
        </div>
      </div>
    </button>
